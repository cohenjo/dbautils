...
REM ***************************************************************************
REM
REM File name...: px_join_no_bloom.sql
REM Author......: Christian Antognini
REM Date........: March 2009
REM Description.: This script shows a parallel join that doesn't use a bloom
REM               filter.
REM Notes.......: -
REM Parameters..: -
REM
...
EXPLAIN PLAN FOR
SELECT /*+ ordered use_hash(t2) no_px_join_filter(t2) */ * 
FROM t1, t2 
WHERE t1.id = t2.id 
AND t1.mod = 42;
...
SELECT /*+ ordered use_hash(t2) px_no_join_filter(t2) */ * 
FROM t1, t2 
WHERE t1.id = t2.id 
AND t1.mod = 42;
