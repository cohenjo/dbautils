...
-- and indexes at which less than 90% of space used.
...
declare OP1 number;
	...
	CURSOR c1 IS SELECT owner,table_name
		     FROM   dba_tables
		     WHERE  initial_extent>1048576;
	CURSOR c2 IS SELECT owner,index_name
		     FROM   dba_indexes
		     WHERE  initial_extent>1048576;
begin
	OPEN C1;
