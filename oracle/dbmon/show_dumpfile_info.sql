CREATE or replace PROCEDURE sys.show_dumpfile_info ( 
...
-- p_file        = simple filename of export dumpfile (case-sensitive) 
  ...
  type valtype  IS VARRAY(20) OF VARCHAR2(2048); 
...
-- ================================= 
  ...
  END LOOP; 
    ...
    --dbms_datapump.KU$_DFHDR_MAX_ITEM_CODE       CONSTANT NUMBER := 15; 
